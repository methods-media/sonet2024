...
<>
                    ...
                    <div  className='!bg-[#05141F] w-full min-h-[50vh]  flex  flex-col justify-between gap-8   items-center py-10  px-3 md:px-10 relative  '>
                        ...
                        <p className={`text-xs text-[#828692] text-center max-w-[90%] md:max-w-[70%] ${isArabic ?'font-[GESSTwoMedium]':'font-[InterRegular]'}`}>
